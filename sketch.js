...
var boy, stone, mango1; 
var mango2, mango3, mango4, mango5;
var mango6, mango7, mango8, mango9, ground, tree;
...
function setup() {
	...
	hold = new Launcher(stone.body, {x:280 , y:575});
...
function draw() {
  ...
  fill("Black")
  textSize(40);
  text("Press Space and get another stone to PLAY!",100,100)
  drawSprites();
  ground.display();
  mango1.display();
  mango2.display();
